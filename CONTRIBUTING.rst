...
Thank you for your help improving **geeservermap**!

**geeservermap** uses `nox <https://nox.thea.codes/en/stable/>`__ to automate several development-related tasks.
...
First off, you'll need your own copy of **geeservermap** codebase. You can clone it for local development like so:
...
.. code-block:: console
   ...
   git clone https://github.com/<YOUR USERNAME>/geeservermap
   cd geeservermap
...
This will install the **geeservermap** library, together with two additional tools:
